...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-indigo-900 via-blue-900 to-gray-900 text-white font-sans">
      {/* Hero Section */}
      ...
      {/* Features Section */}
      <section className="bg-white text-gray-900 py-16 rounded-t-3xl -mt-12">
        <h2 className="text-center text-3xl font-bold mb-12">Discover Powerful Features</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto px-6">
          <Card className="shadow-xl border-none bg-gradient-to-br from-blue-100 to-purple-100">
            <CardContent className="flex flex-col items-center p-6">
              <Brain className="w-10 h-10 text-indigo-700 mb-4" />
          ...
          <Card className="shadow-xl border-none bg-gradient-to-br from-pink-100 to-yellow-100">
            <CardContent className="flex flex-col items-center p-6">
              <MapPin className="w-10 h-10 text-pink-600 mb-4" />
              <h3 className="text-xl font-semibold mb-2">Smart Geo-Tagging</h3>
              <p className="text-gray-600 text-center">
          ...
          <Card className="shadow-xl border-none bg-gradient-to-br from-green-100 to-blue-100">
            <CardContent className="flex flex-col items-center p-6">
      ...
      <section id="user-selection" className="py-20 px-6 bg-gradient-to-r from-indigo-900 via-blue-800 to-indigo-900">
        <h2 className="text-3xl font-bold text-center mb-12">Choose Your Access Type</h2>
        <div className="flex flex-col md:flex-row justify-center gap-8 max-w-4xl mx-auto">
          
          {/* Citizen Access */}
          <motion.div 
            whileHover={{ scale: 1.05 }} 
            className="bg-white/10 p-8 rounded-2xl text-center shadow-md w-full md:w-1/2 backdrop-blur-sm"
          >
      ...
      <section className="py-20 px-6 bg-gradient-to-r from-indigo-900 via-blue-800 to-indigo-900">
        <h2 className="text-3xl font-bold text-center mb-12">Hear From Our Community</h2>
        <div className="flex flex-col md:flex-row justify-center gap-8 max-w-5xl mx-auto">
          {["Empowered Citizens", "Responsive Officials", "Smarter Cities"].map((title, i) => (
            <motion.div 
              key={i} 
              whileHover={{ scale: 1.05 }} 
              className="bg-white/10 p-6 rounded-2xl text-center shadow-md w-full md:w-1/3"
            >
      ...
      <section className="text-center py-20 bg-white text-gray-900">
        <h2 className="text-4xl font-bold mb-6">Join the Future of Smart Governance</h2>
